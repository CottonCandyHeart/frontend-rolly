...
class TrenerHomePage extends StatefulWidget {
  const TrenerHomePage({super.key, required this.title});

  final String title;

  @override
  State<TrenerHomePage> createState() => _TrenerHomePageState();
}

class _TrenerHomePageState extends State<TrenerHomePage> {
  String? selected;
  ...
  Widget build(BuildContext context) {
    ...
    return buildTrenerWindow(context);
    
  }

  @override
  Widget buildTrenerWindow(BuildContext context) {
